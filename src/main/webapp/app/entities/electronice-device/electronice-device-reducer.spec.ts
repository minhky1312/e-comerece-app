...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './electronice-device.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELECTRONICEDEVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ELECTRONICEDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ELECTRONICEDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ELECTRONICEDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ELECTRONICEDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ELECTRONICEDEVICE actions', async () => {
      const expectedActions = [
        {
